...
frm.addEventListener("submit", function (a) {
  a.preventDefault();
  a = document.getElementById("name").value;
  var b = document.getElementById("messege").value;
  window.open(
    "https://wa.me/+918450996596?text=Hi%20I%27m%20" + a + ",%20" + b,
    "_blank"
  );
});
